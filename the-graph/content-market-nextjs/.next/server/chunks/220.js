...
const ButtonPrimaryStyled$1 = (0,_index_js__WEBPACK_IMPORTED_MODULE_3__.f)(_index_js__WEBPACK_IMPORTED_MODULE_3__.h)`
    background-color: ${_index_js__WEBPACK_IMPORTED_MODULE_3__.e.green};
    border-color: ${_index_js__WEBPACK_IMPORTED_MODULE_3__.e.greenLight};
    color: ${_index_js__WEBPACK_IMPORTED_MODULE_3__.e.white};
    ...
    :focus {
        box-shadow: 0px 0px 0px 2px ${_index_js__WEBPACK_IMPORTED_MODULE_3__.e.blue};
    }

    svg {
        fill: ${_index_js__WEBPACK_IMPORTED_MODULE_3__.e.white};
    }
`;
var styles = {
...
const ButtonPrimary = ({
  ...props
}) => /* @__PURE__ */ (0,_index_js__WEBPACK_IMPORTED_MODULE_3__.i)(ButtonPrimaryStyled, {
  ...props
});
